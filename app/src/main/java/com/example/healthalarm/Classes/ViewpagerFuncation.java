...
public class ViewpagerFuncation {
    ...
    public void ViewpagerFuncations (UltraViewPager viewPager){
        ...
        viewPager.getIndicator()
                ...
                .setNormalColor(Color.WHITE).setRadius((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5,viewPager.getResources().getDisplayMetrics()));
